    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-blue-50 to-blue-100 p-4">
            <div className="max-w-2xl w-full bg-white rounded-lg shadow-lg p-8 text-center">
                <h1 className="text-3xl font-bold text-gray-900 mb-6">Anket Uygulaması</h1>
                ...
                <div className="mb-8">
                    <h2 className="text-xl font-semibold text-gray-900 mb-3">Önemli Bilgiler</h2>
                ...
                <button
                    onClick={startSurvey}
                    disabled={isStarting}
                    className={`py-3 px-8 text-white font-medium rounded-lg transition-colors text-base w-full sm:w-auto ${isStarting
