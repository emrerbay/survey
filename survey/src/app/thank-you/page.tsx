    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-blue-50 to-blue-100 p-4">
            <div className="max-w-2xl w-full bg-white rounded-lg shadow-lg p-8 text-center">
                <div className="mb-6">
                    <svg
                        className="w-16 h-16 text-green-700 mx-auto"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                ...
                <button
                    onClick={() => router.push("/")}
                    className="py-3 px-8 bg-blue-700 text-white font-medium rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 transition-colors text-base"
                >
                    Ana Sayfaya Dön
                </button>
            </div>
